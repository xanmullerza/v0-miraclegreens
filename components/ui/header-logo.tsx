...
export function HeaderLogo({ 
    ...
    return (
        <div className={cn(
            "sticky top-0 z-50 flex items-center justify-between p-2 bg-white dark:bg-slate-900 rounded-b-[2rem] border border-slate-200 dark:border-slate-800 shadow-xl w-full md:max-w-[900px] mx-auto xl:mx-0 transition-all duration-500"
        )}>
