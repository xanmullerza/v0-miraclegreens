                        ...
                        <>
                            {pathname === '/dashboard' ? (
                                <div className="flex items-center justify-center py-1 gap-3">
                                    ...
                                    <div className="flex flex-col text-[10px] font-bold uppercase tracking-[0.15em] text-slate-400 dark:text-slate-500 leading-tight border-l border-slate-200 dark:border-slate-800 pl-3 animate-in fade-in slide-in-from-right-4 duration-1000 font-sans">
