...
interface ShoppingSearchProps {
    onSelect: (food: any) => void;
}

export function ShoppingSearch({ onSelect }: ShoppingSearchProps) {
    ...
    return (
        <div className="relative">
            {/* Search Input */}
            <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 focus-within:ring-2 focus-within:ring-emerald-500 transition-all">
                    ...
                    {isSearching ? (
                        ...
                        results.map((food) => (
                            ...
                            >
                                ...
                                <ChevronRight className="text-slate-200 group-hover:text-emerald-500 transition-colors shrink-0" size={16} />
                            </button>
                        ))
                    )}
                </div>
