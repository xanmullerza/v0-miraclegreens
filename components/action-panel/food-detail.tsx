...
export function FoodDetail({ foodId, onBack }: FoodDetailProps) {
    ...
    return (
        <div className="flex flex-col h-full w-full max-w-none animate-in fade-in duration-500 pb-20 overflow-x-hidden">
            ...
            <div className="bg-slate-50 dark:bg-slate-900/50 rounded-[2rem] border border-slate-200 dark:border-slate-800 overflow-hidden mb-6 w-full max-w-full mx-auto">
                <FoodHeader ctx={ctx} />
                
                <div className="px-5 py-4 space-y-6 w-full max-w-full">
