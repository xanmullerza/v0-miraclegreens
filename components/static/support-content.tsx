...
export function SupportContent({ className }: SupportContentProps) {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        ...
        <div className="p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:shadow-lg transition-shadow">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="font-black text-slate-900 dark:text-white uppercase tracking-wider text-sm">Email Support</h3>
          </div>
        ...
        <div className="p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:shadow-lg transition-shadow">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="font-black text-slate-900 dark:text-white uppercase tracking-wider text-sm">Live Chat</h3>
          </div>
          <p className="text-slate-600 dark:text-slate-400 text-sm mb-4">
        ...
        <div className="p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:shadow-lg transition-shadow">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="font-black text-slate-900 dark:text-white uppercase tracking-wider text-sm">Phone Support</h3>
          </div>
          <p className="text-slate-600 dark:text-slate-400 text-sm mb-4">
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: "Click the \"Forgot Password\" link on the login page and follow the instructions sent to your email address. You'll receive a password reset link valid for 24 hours."
              },
              {
                q: "Can I export my nutritional data?",
                a: "Yes! You can export your meal history, nutritional data, and recipes in various formats from your account settings. This feature helps you maintain a backup of your data."
              },
              {
                q: "How accurate is the nutritional information?",
                a: "Our nutritional data is sourced from verified databases and updated regularly. However, actual nutrition content may vary based on production methods and specific brands. Always consult with a nutritionist for personalized advice."
              },
              {
                q: "Is my data secure and private?",
                a: "Yes, we use industry-standard encryption and security protocols to protect your data. Please review our Privacy Policy for more details on how we handle your information."
              }
            ].map((faq, i) => (
              <details key={i} className="p-4 rounded-lg border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50 group cursor-pointer">
