...
function FamilyMemberForm({
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-slate-950 w-full max-w-2xl rounded-[2rem] shadow-2xl flex flex-col max-h-[90vh]"
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                Define bio-data for calculation
              </p>
            </div>
          </div>
          <button
            ...
            <div className="space-y-2">
              ...
              <div className="flex bg-slate-100 dark:bg-slate-900 p-1 rounded-xl h-10">
                <button
                  ...
                  className={cn(
                    'flex-1 text-xs font-black uppercase tracking-wider rounded-lg transition-all',
                    data.gender === 'male'
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-slate-50 dark:bg-slate-900 border-slate-200 dark:border-slate-800 rounded-xl font-bold text-center"
              />
            </div>
            <div className="space-y-2">
              <Label className="text-[10px] font-black uppercase tracking-widest text-slate-400">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2 overflow-x-auto pb-2">
              <GoalCard
                ...
                onClick={() => setData({ ...data, activityLevel: 'sedentary' })}
                icon={User}
              />
              <GoalCard
                type="light"
                ...
                onClick={() => setData({ ...data, activityLevel: 'light' })}
                icon={ChevronRight}
              />
              <GoalCard
                type="moderate"
                ...
                onClick={() => setData({ ...data, activityLevel: 'moderate' })}
                icon={Zap}
              />
              <GoalCard
                type="active"
                ...
                onClick={() => setData({ ...data, activityLevel: 'active' })}
                icon={Flame}
              />
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              <GoalCard
                type="lose-fat"
                label="Lose Fat"
                selected={data.goal === 'lose-fat'}
                onClick={() => setData({ ...data, goal: 'lose-fat' })}
                icon={TrendingDown}
              />
              <GoalCard
                type="maintain"
        ...
        <div className="p-6 border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 rounded-b-[2rem] flex justify-end gap-3">
          ...
          <Button
            onClick={() => onSave(data)}
            className="bg-purple-500 hover:bg-purple-600 text-white font-bold rounded-xl px-8"
          >
            Save Profile
          </Button>
        </div>
...
function ProfileContentInner({ className }: { className?: string }) {
  ...
  const {
    activeView,
    setActiveView: setActiveViewContext,
    setPreviousView,
    navigateTo,
    goBack,
  } = useActionPanel();
  ...
  const COUNTRY_PRESETS: Record<
    string,
    { energy: 'kJ' | 'kcal'; measurement: 'metric' | 'imperial' }
  > = {
              ...
              {loading ? (
                ...
                <>
                  <svg className="w-3.5 h-3.5" viewBox="0 0 24 24">
                    ...
                    />
                    <path
                      d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1c-3.17 0-5.92 1.83-7.23 4.51L8.55 8.35c.67-2.02 2.44-3.47 5.05-3.47z"
                      fill="currentColor"
                      opacity="0.4"
                    />
                  </svg>
      ...
      <div className="flex flex-col gap-6 items-start justify-center overflow-x-hidden">
        <div className="max-w-2xl w-full mx-auto space-y-8 pb-10">
          <div className="grid grid-cols-1 gap-8">
            ...
            <section className="space-y-1">
              ...
              >
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <div className="text-left">
                    <h2 className="text-lg font-black uppercase tracking-wider text-slate-900 dark:text-white italic">
                      Measures
                    </h2>
                ...
                <div
                  className={cn(
                    ...
                    expandedAccordion === 'measures' ? 'rotate-180' : '',
                  )}
                >
                  <ChevronDown size={20} />
                </div>
              ...
              {expandedAccordion === 'measures' && (
                <div className="bg-white dark:bg-slate-900/50 rounded-b-2xl p-8 space-y-8 shadow-md relative overflow-hidden border border-t-0 border-emerald-500/20">
                  {user && (
                    <div className="space-y-4">
                      <Label className="text-[10px] font-black uppercase tracking-widest text-slate-400 border-b border-slate-100 dark:border-slate-800 pb-1 block">
                        Your Region
                      </Label>
            ...
            {/* Identification Card */}
            <section
              className={cn('space-y-1', !user && 'opacity-50 grayscale pointer-events-none')}
            >
              <button
              ...
              >
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">
                      Basic Information {!user && '(Sign in to edit)'}
                    </p>
                  </div>
                </div>
                <div
                  className={cn(
                    'text-emerald-500 transition-transform duration-300',
                    expandedAccordion === 'identification' ? 'rotate-180' : '',
                  )}
                >
                  <ChevronDown size={20} />
                </div>
              ...
              {expandedAccordion === 'identification' && (
                <div className="bg-white dark:bg-slate-900/50 rounded-b-2xl p-8 space-y-8 shadow-md relative overflow-hidden border border-t-0 border-emerald-500/20">
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-6 border-t border-slate-100 dark:border-slate-800">
                    ...
                    <div className="space-y-2">
                      <Label className="text-[10px] font-black uppercase tracking-widest text-slate-400 border-b border-slate-100 dark:border-slate-800 pb-1 block">
                        Weight ({measurementUnit === 'imperial' ? 'lb' : 'kg'})
                      </Label>
                      <div className="relative group/stepper">
                        <Input
                          type="number"
                    ...
                    <div className="space-y-2">
                      <Label className="text-[10px] font-black uppercase tracking-widest text-slate-400 border-b border-slate-100 dark:border-slate-800 pb-1 block">
                        Height ({measurementUnit === 'imperial' ? 'in' : 'cm'})
                      </Label>
                      <div className="relative group/stepper">
                        <Input
                          type="number"
              ...
              >
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">
                      Fitness Direction {!user && '(Sign in to edit)'}
                    </p>
                  </div>
                </div>
                <div
                  className={cn(
                    'text-emerald-500 transition-transform duration-300',
                    expandedAccordion === 'goals' ? 'rotate-180' : '',
                  )}
                >
                  <ChevronDown size={20} />
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <GoalCard
                        ...
                        onClick={() => setFormData({ ...formData, goal: 'lose-fat' })}
                        icon={TrendingDown}
                      />
                      <GoalCard
                        type="maintain"
              ...
              >
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">
                      Nutritional Approach {!user && '(Sign in to edit)'}
                    </p>
                  </div>
                </div>
                <div
                  className={cn(
                    'text-emerald-500 transition-transform duration-300',
                    expandedAccordion === 'dietary' ? 'rotate-180' : '',
                  )}
                >
                  <ChevronDown size={20} />
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                      <GoalCard
                        type="anything"
                        label="Balanced"
                        selected={formData.dietType === 'anything'}
                        onClick={() => setFormData({ ...formData, dietType: 'anything' })}
                        icon={Apple}
                      />
                      <GoalCard
                        type="pescatarian"
                        label="Pescatarian"
                        selected={formData.dietType === 'pescatarian'}
                        onClick={() => setFormData({ ...formData, dietType: 'pescatarian' })}
                        icon={Fish}
                      />
                      <GoalCard
                        type="vegetarian"
                      ...
                      <GoalCard
                        ...
                        onClick={() => setFormData({ ...formData, dietType: 'vegan' })}
                        icon={Leaf}
                      />
                    </div>
                  </div>
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
                      <GoalCard
                        type="balanced"
                        label="Balanced"
                        selected={formData.nutrientStrategy === 'balanced'}
                        onClick={() => setFormData({ ...formData, nutrientStrategy: 'balanced' })}
                        icon={Activity}
                      />
                      <GoalCard
                        type="low-carb"
                        label="Low Carb"
                        selected={formData.nutrientStrategy === 'low-carb'}
                        onClick={() => setFormData({ ...formData, nutrientStrategy: 'low-carb' })}
                        icon={TrendingDown}
                      />
                      <GoalCard
                        type="high-protein"
                        label="High Protein"
                        selected={formData.nutrientStrategy === 'high-protein'}
                        onClick={() =>
                          setFormData({ ...formData, nutrientStrategy: 'high-protein' })
                        }
                        icon={Dumbbell}
                      />
                      <GoalCard
                        type="keto"
                        label="Keto Diet"
                        selected={formData.nutrientStrategy === 'keto'}
                        onClick={() => setFormData({ ...formData, nutrientStrategy: 'keto' })}
                        icon={Zap}
                      />
                      <GoalCard
                        type="high-carb"
                        label="High Carb"
                        selected={formData.nutrientStrategy === 'high-carb'}
                        onClick={() => setFormData({ ...formData, nutrientStrategy: 'high-carb' })}
                        icon={Apple}
                      />
                    </div>
                  </div>
              ...
              <section className="space-y-1">
                ...
                >
                  ...
                  <div
                    className={cn(
                      'text-emerald-500 transition-transform duration-300',
                      expandedAccordion === 'admin' ? 'rotate-180' : '',
                    )}
                  >
                    <ChevronDown size={20} />
                  </div>
                ...
                {expandedAccordion === 'admin' && (
                  <div className="bg-white dark:bg-slate-900/50 rounded-b-2xl p-8 space-y-6 shadow-md relative overflow-hidden border border-t-0 border-emerald-500/20">
                    <Button
                      asChild
                      className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-black h-12 rounded-xl flex items-center justify-between px-6"
                    >
                      <Link href="/admin">
                        <div className="flex items-center gap-3">
                          <LayoutGrid size={16} />
