                            ...
                            {loading ? (
                                ...
                                <>
                                    <svg className="w-3.5 h-3.5" viewBox="0 0 24 24">
                                        ...
                                        <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1c-3.17 0-5.92 1.83-7.23 4.51L8.55 8.35c.67-2.02 2.44-3.47 5.05-3.47z" fill="currentColor" opacity="0.4" />
                                    </svg>
                                    <span>Sign In</span>
                                </>
                            )}
