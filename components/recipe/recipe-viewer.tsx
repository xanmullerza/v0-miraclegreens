            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-6 mb-6">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-2">
                        <span className="text-sm text-green-700">Servings:</span>
                        <span className="w-16 px-2 py-1 border border-green-300 rounded text-center bg-white text-green-900">{originalServings}</span>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-white rounded-lg p-4 text-center">
                        ...
                        <div className="text-2xl font-bold text-gray-900">
                            {energyUnit === 'kJ'
                                ? Math.round(perServing.calories * CAL_TO_KJ).toLocaleString()
                                : perServing.calories.toLocaleString()}
                        </div>
                    ...
                    <div className="bg-white rounded-lg p-4 text-center">
                        ...
                        <div className="text-2xl font-bold text-gray-900">{perServing.protein}g</div>
                    ...
                    <div className="bg-white rounded-lg p-4 text-center">
                        ...
                        <div className="text-2xl font-bold text-gray-900">{perServing.fat}g</div>
                    ...
                    <div className="bg-white rounded-lg p-4 text-center">
                        ...
                        <div className="text-2xl font-bold text-gray-900">{perServing.carbs}g</div>
