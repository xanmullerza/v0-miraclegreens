    ...
    <section id="story" className="py-16 md:py-24 bg-background">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <p className="text-sm font-medium text-primary uppercase tracking-wider mb-2">Our Journey</p>
          <h2 className="font-serif text-3xl md:text-4xl font-semibold text-foreground">From Sourcing to Growing</h2>
          <p className="mt-4 text-muted-foreground max-w-2xl mx-auto">
            We've built a strong foundation sourcing quality moringa. Now we're ready to take the next step — with your
            help.
          </p>
        </div>
