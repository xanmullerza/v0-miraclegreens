...
export function RecipesViewPremium({
    ...
    return (
        <div className="space-y-0 animate-in fade-in duration-500">
            ...
            <div className="w-full max-w-6xl mx-auto bg-slate-100/10 dark:bg-transparent rounded-[2rem] border border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden">
                
                {/* Big Tab Bar - Inside Card */}
                <div className="sticky top-0 z-20 bg-white/20 dark:bg-slate-900/20 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800 py-4 px-4">
                ...
                {(activeTab === 'recipes' || activeTab === 'remixes' || activeTab === 'mixes') && (
                    <>
                        ...
                        <div className="sticky top-[68px] z-10 bg-white/10 dark:bg-slate-900/10 backdrop-blur-md border-b border-slate-200 dark:border-slate-800">
