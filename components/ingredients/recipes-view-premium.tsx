                        ...
                        <div className="px-4 sm:px-6 py-2 flex items-center gap-2">
                            ...
                            <div className="flex-1 relative max-w-sm sm:max-w-md">
                                ...
                                <input
                                    ...
                                    className="w-full pl-9 pr-8 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-[10px] font-bold focus:outline-none focus:ring-2 focus:ring-emerald-500/20 placeholder:text-slate-400 transition-all shadow-sm"
                                />
                                {searchQuery && (
                                    <button
