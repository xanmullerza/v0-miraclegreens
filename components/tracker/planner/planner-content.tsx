                        ...
                        {!user ? (
                            <>
                                ...
                                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
                                    <Button 
                                        variant="outline" 
                                        className="h-10 rounded-full px-6 bg-white text-slate-900 border-none hover:bg-slate-100 font-bold text-xs flex items-center justify-center gap-2 group transition-all"
                                    ...
                                    >
                                        ...
                                        <span className="text-slate-900 whitespace-nowrap font-semibold text-sm">Continue with Google</span>
                                    </Button>
                                </div>
                            </>
                        ) : isProfileIncomplete ? (
