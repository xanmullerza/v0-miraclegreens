        ...
        <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500 pb-24">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-4 border-b border-slate-200 dark:border-slate-800">
                <div className="space-y-1">
                    <h1 className="text-3xl font-black tracking-tighter text-slate-900 dark:text-white uppercase italic">Biological Protocol</h1>
                    <p className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em]">{step < 3 ? 'Configuration' : 'Live Execution'}</p>
                </div>
                {step === 3 && (
                    <div className="flex items-center gap-3">
                        <Button 
                            ...
                            className="h-10 px-4 rounded-xl text-[10px] uppercase font-black tracking-widest gap-2 bg-slate-900 text-white border-slate-800 hover:bg-slate-800"
                        >
            ...
            {step < 3 && (
                <div className="flex flex-col items-center justify-center space-y-6 pt-4">
                    <div className="max-w-2xl w-full p-8 rounded-[2rem] bg-slate-900 border border-slate-700/50 shadow-2xl text-center space-y-4">
                        <h2 className="text-xl font-black uppercase tracking-tighter text-white">Generate Your Personalized Protocol</h2>
                        <p className="text-sm font-medium text-slate-400">
                            Fill in your basic information to generate a personalised daily meal plan.
                            <br />
                            <span className="text-emerald-400 font-bold">Sign up or Log In</span> to generate a full weekly meal plan.
                        </p>
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
                            <Button variant="outline" className="h-10 rounded-full px-6 bg-white text-slate-900 border-none hover:bg-slate-200 font-bold text-xs flex items-center gap-2">
