...
export function parseNutritionText(text: string): Partial<ParsedNutrition> {
    ...
    const microMap: Record<string, string | RegExp> = {
        ...
        'Sugars': /^Sugars$/i,
        'Starch': /^Starch$/i,
        'Saturated Fat': /\bSaturated\b/i,
        'Monounsaturated Fat': /\bMonounsaturated\b/i,
        'Polyunsaturated Fat': /\bPolyunsaturated\b/i,
        'Trans Fat': /\bTrans\b/i,
        'Cholesterol': /\bCholesterol\b/i,
        'Phytosterol': /\bPhytosterol\b/i,
