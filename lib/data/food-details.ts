...
export const FOOD_DETAILS: Record<string, FoodDetail> = {
    ...
    // Vanilla
    "e70eb21b-eb8b-4af8-9532-294778cfd57b": {
        description: "Flavoring derived from orchids of the genus Vanilla.",
        history: "Cultivated by Totonacs of Mexico. Spanish conquistadors brought it to Europe.",
        producers: "Madagascar (80%), Indonesia.",
        benefits: ["Calming aroma.", "Antioxidant.", "Sweetness without sugar."],
        facts: ["Second most expensive spice after saffron.", "Flower opens for only 24 hours."]
    },
    // Tomato Raw
    "29f2a6ee-bb6e-4569-bccb-1179abcca23f": {
        description: "Edible berry of Solanum lycopersicum.",
        history: "Andes origin. Aztecs used it. Thought poisonous in Europe due to lead plates.",
        producers: "China, USA, India.",
        benefits: ["Lycopene (prostate health).", "Vitamin C.", "Potassium."],
        facts: ["Technically a fruit (botanically).", "La Tomatina festival involves throwing them."]
    },
    // Quinoa
    "950bc457-23b4-4db2-86f8-60d6ea3341b3": {
        description: "Flowering plant of the Amaranth family, grown for edible seeds.",
        history: "Domesticated in Andes 3000-4000 years ago. 'Mother of all grains' (Inca).",
        producers: "Peru, Bolivia.",
        benefits: ["Complete protein.", "Fiber.", "Minerals (Mg, Fe)."],
        facts: ["NASA considered it for long-duration space flights.", "Coat contains bitter saponins."]
    },
    // Watermelon
    "bb9a7c62-1985-411f-94fe-8448ac366203": {
        description: "Scrambling and trailing vine-like plant.",
        history: "Originated in Africa. Seeds found in Pharaoh tombs.",
        producers: "China, Turkey.",
        benefits: ["Hydration (92%).", "Citrulline (blood flow).", "Lycopene."],
        facts: ["Both a fruit and a vegetable.", "Japan grows square ones."]
    },
    // Walnuts
    "6c4d071c-5509-4ff1-8957-6a9e6eb63eb2": {
        description: "Nut of any tree of the genus Juglans.",
        history: "Oldest tree food known (7000 BC).",
        producers: "China, USA.",
        benefits: ["Omega-3 (ALA).", "Brain health.", "Gut health."],
        facts: ["Shaped like a brain.", "Shells used for cleaning (blasting)."]
    },
    // Split Peas
    "078ff8ee-e9dc-44ef-b717-09a01249e860": {
        description: "Dried, peeled and split seeds of Pisum sativum.",
        history: "Cultivated 8000+ years in Near East.",
        producers: "Canada, Russia.",
        benefits: ["Protein dense.", "Fiber.", "Low glycemic."],
        facts: ["Made famous by soup.", "Peas were originally grown only for dried seeds."]
    },
    // Pear
    "5218eef3-f5ca-4bf7-977d-e894e600d753": {
        description: "Sweet pomaceous fruit.",
        history: "Cultivated in China 3000+ years.",
        producers: "China, Argentina.",
        benefits: ["Hypoallergenic.", "Fiber.", "Gout (removes uric acid)."],
        facts: ["Ripen from the inside out.", "Wood used for musical instruments."]
    },
    // Sesame Seeds
    "63043a71-c781-4320-a417-c468e5a72576": {
        description: "Oil-rich seeds.",
        history: "One of the oldest oilseed crops. 'Open Sesame' reflects pod popping.",
        producers: "Tanzania, India, Sudan.",
        benefits: ["Calcium boost.", "Healthy fats.", "Lignans."],
        facts: ["Source of tahini.", "Can cause allergy (major allergen)."]
    },
    // Pecans
    "f5e6990f-579e-434f-8522-1b571043b2b1": {
        description: "Hickory tree nut.",
        history: "Native to southern USA/Mexico. Essential to Native Americans.",
        producers: "USA, Mexico.",
        benefits: ["Heart health.", "Antioxidants.", "Zinc."],
        facts: ["State tree of Texas.", "Name means 'nut requiring stone to crack'."]
    },
    // Pilchards (Sardines)
    "1dfdcfec-8357-4f20-be4c-1b159bd51186": {
        description: "Small, oily fish.",
        history: "Named after Sardinia island.",
        producers: "Morocco, Peru.",
        benefits: ["Omega-3s.", "Calcium (bones).", "B12."],
        facts: ["One of the safest fish (low mercury).", "Usually packed in oil or tomato."]
    },
    // Plum
    "c3ff5fb1-1b3d-4c3e-afed-afb6c361db2e": {
        description: "Stone fruit.",
        history: "Cultivated in China 2000+ years ago.",
        producers: "China, Romania.",
        benefits: ["Constipation relief (fiber/sorbitol).", "Antioxidants.", "Bone health."],
        facts: ["Dried plums are prunes.", "Bloom on skin protects moisture."]
    },
    // Sunflower Seeds
    "a5c60c46-52fe-4e8a-b73b-094130218f07": {
        description: "Fruit of the sunflower.",
        history: "Domesticated in Americas 1000 BC.",
        producers: "Ukraine, Russia.",
        benefits: ["Vitamin E.", "Selenium.", "Magnesium."],
        facts: ["Flowers track the sun (heliotropism).", "Chernobyl cleanup used sunflowers."]
    },
    // Sunflower Oil
    "9b8da72e-9baa-4269-a9e4-d6f0bfe91aec": {
        description: "Pressed oil from sunflower seeds.",
        history: "First processed in Russia 1830s.",
        producers: "Ukraine, Russia.",
        benefits: ["Vitamin E.", "High heat cooking.", "Polyunsaturated fats."],
        facts: ["Used in biodiesel.", "Light flavour."]
    },
    // White Flour
    "7d43c712-3f81-40a3-b5ed-57e793d9c595": {
        description: "Fine powder from wheat berries.",
        history: "Milling dates back to 6000 BC.",
        producers: "China, India.",
        benefits: ["Energy (Carbs).", "Folic acid (if fortified).", "Baking structure."],
        facts: ["Bran/germ removed.", "Shelf stable vs whole wheat."]
    },
    // Green Peas
    "dc022ed7-f593-4160-acb6-b72eafa0d7c8": {
        description: "Small spherical seeds in pods.",
        history: "Mendel used them for genetics.",
        producers: "Canada, France.",
        benefits: ["Protein.", "Fiber.", "Vitamins A/K."],
        facts: ["Frozen often fresher than 'fresh'.", "One of the earliest crops."]
    },
    // Thyme
    "27b3c797-f1f6-4dc6-8b7a-23aa5127b00b": {
        description: "Aromatic herb of mint family.",
        history: "Egyptians used for embalming. Greeks for bath.",
        producers: "Europe, Morocco.",
        benefits: ["Thymol (antiseptic).", "Respiratory health.", "Vitamin C."],
        facts: ["Symbol of courage.", "Used to ward off nightmares."]
    },
    // Rosemary
    "7cd3e495-5978-4d37-af61-208dac7bf61f": {
        description: "Woody, perennial herb.",
        history: "Mediterranean. 'Dew of the Sea'.",
        producers: "Spain, Morocco.",
        benefits: ["Memory focus.", "Anti-inflammatory.", "Hair growth."],
        facts: ["Used at weddings.", "Antioxidants preserve food."]
    },
    // Apricot Jam
    "58e35d9c-38e2-4a55-a917-36bbab37c388": {
        description: "Preserve made from apricots and sugar.",
        history: "Preserving fruit with honey dates to Rome.",
        producers: "Global.",
        benefits: ["Quick energy.", "Some fruit fiber.", "Enjoyment."],
        facts: ["Pectin sets the jam.", "Originally a way to store fruit for winter."]
    },
    // Mayonnaise
    "89ee01b8-9e29-4468-a8e0-570aaf4cb18f": {
        description: "Thick cold condiment of oil, egg yolk, and acid.",
        history: "Disputed origin (French/Spanish). Minorca 1756?",
        producers: "Global.",
        benefits: ["Vitamin E.", "Fat absorption.", "Calorie dense."],
        facts: ["An emulsion.", "Commercial mayo is 65-80% oil."]
    },
    // Spinach Cooked
    "a82b8a77-7dcb-4279-8a4d-b03854df20d5": {
        description: "Nutrient dense leafy green, heated.",
        history: "Persian origin. Spain 12th C.",
        producers: "China (90%).",
        benefits: ["Iron absorption better than raw.", "Vitamin A/K.", "Folate."],
        facts: ["Shrinks rapidly.", "Popeye boosted consumption by 33%."]
    },
    // Kale Cooked
    "280dfb32-5c94-44bb-9fd9-3a32afe19a1e": {
        description: "Cooked leaf cabbage.",
        history: "See Kale Raw.",
        producers: "Europe, USA.",
        benefits: ["Easier digestion.", "Nutrient density.", "Lower goitrogens."],
        facts: ["Takes on sweeter flavor.", "Staple in Dutch 'stamppot'."]
    },
    // Potato
    "27a9db01-b800-4cb6-a5e3-f2e2086929df": {
        description: "Starchy tuber.",
        history: "Andes origin. Staple of Incas. Europe 16th C.",
        producers: "China, India, Russia.",
        benefits: ["Potassium (skin).", "Vitamin C.", "Resistant starch (cooled)."],
        facts: ["First vegetable in space.", "Irish Famine caused by blight."]
    },
    // Sweet Potato
    "b2d71b8c-66d3-4e48-a513-2372d0d6a7df": {
        description: "Sweet, starchy root vegetable.",
        history: "Central/South America. 5000 years old.",
        producers: "China (top producer).",
        benefits: ["Vitamin A superfood.", "Fiber.", "Lower GI than potato."],
        facts: ["Not a yam.", "Okinawan staple (longevity)."]
    },
    // Tomato Sauce
    "6a79976c-f45c-4971-9ea9-f6efc5dddec6": {
        description: "Sauce made primarily from tomatoes.",
        history: "Italian pasta sauce ~18th century.",
        producers: "Italy, USA.",
        benefits: ["Concentrated Lycopene.", "Heart health.", "Convenience."],
        facts: ["Cooking tomatoes releases more lycopene.", "Often contains herbs."]
    },
    // Tomato Paste
    "b0493416-25d4-4a95-b523-9cb842e7a4b3": {
        description: "Thick paste of cooked-down tomatoes.",
        history: "Traditional way to dry tomatoes in sun (Sicily).",
        producers: "Italy, China.",
        benefits: ["Umami bomb.", "Highest lycopene concentration.", "Thickener."],
        facts: ["Seeds and skins removed.", "Made by cooking for hours."]
    }
};
