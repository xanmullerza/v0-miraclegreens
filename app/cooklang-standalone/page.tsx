            ...
            <div className="bg-slate-50 rounded-xl border border-slate-200 p-6 space-y-4">
              ...
              <div className="space-y-2">
                <label className="block">
                  <span className="bg-slate-200 hover:bg-slate-300 text-slate-700 px-4 py-2 rounded-lg cursor-pointer font-medium transition-colors inline-block">Upload File</span>
                  <input
                    type="file"
                    accept=".cook,.txt"
