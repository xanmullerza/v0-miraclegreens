...
import { ChefHat, ArrowRight, Leaf, Activity, Calendar, Scale, Package, ShoppingCart } from "lucide-react";
...
export default function KitchenPage() {
    ...
    const heroCards = [
        ...
        { id: "compare", title: "Compare", desc: "Side-by-side food analysis", href: "/dashboard/kitchen/comparefoods", icon: Scale, color: "text-violet-400", bg: "bg-violet-500/10", borderHover: "hover:border-violet-500/40", gradient: "from-violet-500 to-purple-600" },
                    ...
                    <div className="w-full max-w-7xl relative">
                        <div className="relative rounded-[2.5rem] bg-slate-900 border border-slate-800 mt-6 pt-12 pb-8 px-8 lg:mt-8 lg:pt-16 lg:pb-12 lg:px-12 xl:mt-10 xl:pt-20 xl:pb-16 xl:px-16 w-full flex items-center gap-6">
                            ...
                            <div className="flex-1 relative z-10">
                                ...
                                <p className="text-base lg:text-lg text-slate-400 leading-relaxed max-w-md">Tools, measures and pantry essentials to build better recipes. Plan meals, manage your pantry, organize shopping lists, and compare nutritional profiles side-by-side.</p>
