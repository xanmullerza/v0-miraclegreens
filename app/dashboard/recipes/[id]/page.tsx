                        ...
                        <div className="pt-8 border-t border-slate-100 dark:border-slate-800 animate-in slide-in-from-top-4 duration-500">
                            {(() => {
                                ...
                                const NUTRIENT_BREAKDOWNS: Record<string, any[]> = {
                                    ...
                                    'Fat': [
                                        { label: 'Saturated Fat', keys: ['Saturated Fat', 'Saturated', 'saturated_fat_g', 'saturated_g'], unit: 'g' },
                                        { label: 'Monounsaturated', keys: ['Monounsaturated Fat', 'Monounsaturated', 'monounsaturated_fat_g'], unit: 'g' },
                                        { label: 'Polyunsaturated', keys: ['Polyunsaturated Fat', 'Polyunsaturated', 'polyunsaturated_fat_g'], unit: 'g' },
