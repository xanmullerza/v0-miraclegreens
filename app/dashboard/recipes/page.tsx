...
type TabId = 'mixlab' | 'mealplanner' | 'browse' | 'lab';
...
function KitchenContent() {
    ...
    const allTabs: TabId[] = ['mixlab', 'mealplanner', 'browse', 'lab'];
    ...
    const mealsTabs = [
        ...
        { id: 'lab' as TabId, label: 'Lab', icon: Beaker, color: 'text-violet-500', bg: 'bg-violet-500/10' },
    ];
