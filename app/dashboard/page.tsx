                        ...
                        <div className="flex-none">
                            <div className="grid grid-cols-2 gap-3 lg:gap-4 justify-items-center">
                                {heroCards.map((card) => {
                                    ...
                                    if (isDisabled) {
                                        return (
                                            <div key={card.id} className="relative overflow-hidden rounded-2xl lg:rounded-[1.5rem] border border-slate-700/30 bg-slate-800/20 p-5 lg:p-6 opacity-60 cursor-not-allowed select-none group w-44 sm:w-48 lg:w-56 aspect-square">
                                                ...
                                                <div className="relative z-10 grayscale opacity-50 transition-all duration-300 group-hover:opacity-70 group-hover:grayscale-0">
                                                    ...
                                                    <h3 className="text-sm font-black text-slate-400 mb-1 tracking-tight">{card.title}</h3>
                                                    <p className="text-[11px] text-slate-600 leading-snug mb-4">{card.desc}</p>
                                    ...
                                    return (
                                        <Link key={card.id} href={card.href} className={cn("group relative overflow-hidden rounded-2xl lg:rounded-[1.5rem] border border-slate-700/60 bg-slate-800/40 backdrop-blur-sm p-5 lg:p-6 transition-all duration-500 w-44 sm:w-48 lg:w-56 aspect-square", card.borderHover, "hover:bg-slate-800/70 hover:shadow-2xl")}>
