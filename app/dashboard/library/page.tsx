                            ...
                            <DropdownMenu>
                                    ...
                                    <button className={cn(
                                        ...
                                        <span>
                                            {selectedTop10Categories.length === 0 ? "No Categories" :
                                                selectedTop10Categories.length === CATEGORIES.length ? "All Categories" :
                                ...
                                <DropdownMenuContent align="start" className="w-56 p-2 rounded-2xl border-slate-200 dark:border-slate-800 shadow-2xl bg-white dark:bg-slate-950">
                                    ...
                                    <button
                                        ...
                                        className="w-full text-left px-3 py-2 text-[9px] font-black uppercase tracking-widest text-blue-500 hover:text-blue-600 transition-colors"
                                    >
                                        Select All
                                    </button>
                                </DropdownMenuContent>
