                            ...
                            <div className="flex-none">
                                <div className="grid grid-cols-2 grid-rows-2 gap-1 lg:gap-2 justify-items-center">
                                    {heroCards.map((card) => {
                                        ...
                                        return (
                                            <Link key={card.id} href={card.href} className={cn("group relative overflow-hidden rounded-2xl lg:rounded-[1.5rem] border border-slate-700/60 bg-slate-800/40 backdrop-blur-sm p-5 lg:p-6 transition-all duration-500 w-36 sm:w-40 lg:w-44 aspect-square", card.borderHover, "hover:bg-slate-800/70 hover:shadow-2xl")}>
                                                ...
                                                <div className="relative z-10">
                                                    <div className={cn("w-10 h-10 lg:w-11 lg:h-11 rounded-xl flex items-center justify-center mb-4 transition-all duration-500", card.bg)}>
