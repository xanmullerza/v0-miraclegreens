            ...
            <div className="relative h-48 rounded-[2.5rem] bg-indigo-500 overflow-hidden flex items-center px-12 group">
                ...
                <div className="absolute right-12 top-1/2 -translate-y-1/2 flex items-center gap-6">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        <Button
                            className="bg-white text-indigo-600 border-none shadow-xl gap-2 px-4 h-11 rounded-xl font-black uppercase tracking-widest pointer-events-none text-[10px]"
                        >
                            <Scale size={14} />
                            Compare
                        </Button>
                        ...
                        <Button
                            onClick={() => router.push('/dashboard/add-food')}
                            className="bg-white/10 hover:bg-white/20 text-white border border-white/20 backdrop-blur-md shadow-xl gap-2 px-4 h-11 rounded-xl font-black uppercase tracking-widest group/btn transition-all text-[10px]"
                        >
