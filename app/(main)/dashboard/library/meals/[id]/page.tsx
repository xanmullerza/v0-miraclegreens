        ...
        <PageContainer maxWidth="max-w-6xl">
            <div className="space-y-8 pb-20 animate-in fade-in duration-700">
                <div className="space-y-8">
                    {/* Main Header Section - Matching Food Page */}
                        ...
                        <div className="space-y-3 animate-in fade-in slide-in-from-top-2 duration-300">
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-[9px] font-bold text-slate-400 mt-0.5">
                                        {recipe.is_favorite ? 'This meal is in your favourites collection' : 'Save this meal for quick access'}
                                    </p>
                                </div>
                            </button>
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[9px] font-bold text-slate-400 mt-0.5">Modify meal</p>
                                        </div>
                                    </button>
                                    <button
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[9px] font-bold text-slate-400 mt-0.5">Remove meal</p>
                                        </div>
                                    </button>
                                </div>
                            )}
