            ...
            <div className="lg:grid lg:grid-cols-[120px_1fr_100px_80px_80px_80px_150px] gap-4 lg:items-center lg:px-8">
                ...
                <div className="p-3 lg:p-0">
                    ...
                    {(() => {
                        ...
                        const colors = {
                            green:  { btn: 'border-emerald-500/30 bg-emerald-500/10 text-emerald-500 hover:bg-emerald-500', badge: 'bg-emerald-500/10 text-emerald-600', pill: 'bg-emerald-500 text-white', missing: 'border-emerald-500/30 bg-emerald-500/10 text-emerald-500 hover:bg-emerald-500', missingLabel: 'text-emerald-500/60', missingItem: 'text-emerald-600 dark:text-emerald-400 bg-emerald-500/5 border-emerald-500/10' },
                            blue:   { btn: 'border-blue-500/30 bg-blue-500/10 text-blue-500 hover:bg-blue-500', badge: 'bg-blue-500/10 text-blue-600', pill: 'bg-blue-500 text-white', missing: 'border-blue-500/30 bg-blue-500/10 text-blue-500 hover:bg-blue-500', missingLabel: 'text-blue-500/60', missingItem: 'text-blue-600 dark:text-blue-400 bg-blue-500/5 border-blue-500/10' },
                            orange: { btn: 'border-amber-500/30 bg-amber-500/10 text-amber-500 hover:bg-amber-500', badge: 'bg-amber-500/10 text-amber-600', pill: 'bg-amber-500 text-white', missing: 'border-amber-500/30 bg-amber-500/10 text-amber-500 hover:bg-amber-500', missingLabel: 'text-amber-500/60', missingItem: 'text-amber-600 dark:text-amber-400 bg-amber-500/5 border-amber-500/10' },
                        };
                        const c = colors[tier];
                        return (
                        ...
                        {uniqueMissing.length > 0 && (
                            <div className="flex flex-wrap items-center gap-1.5">
                                <Link
                                    ...
                                    onClick={(e: React.MouseEvent) => e.stopPropagation()}
                                    className={cn("text-[9px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full border hover:text-white transition-all flex items-center gap-1.5", c.missing)}
                                >
                                    <ShoppingBasket size={10} />
                                    Groceries
                                </Link>
                                <span className={cn("text-[9px] font-black uppercase tracking-widest", c.missingLabel)}>Missing:</span>
                                {uniqueMissing.map((ing, idx) => (
                                    <span key={idx} className={cn("text-[9px] font-bold px-1.5 py-0.5 rounded-md border", c.missingItem)}>
                                        {ing}
                                    </span>
                                ))}
                            </div>
