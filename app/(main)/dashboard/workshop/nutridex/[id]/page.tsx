                        ...
                        {MACROS_LIST.map(id => (
                            <DropdownMenuCheckboxItem
                                ...
                                onCheckedChange={() => {
                                    ...
                                    router.push(`/dashboard/workshop/nutridex/${encodeURIComponent(id)}?${params.toString()}`);
                                }}
    ...
    if (!info) {
        return (
            <div className="h-[70vh] flex flex-col items-center justify-center gap-6">
                ...
                <Button onClick={() => router.push('/dashboard/workshop/nutridex')} className="rounded-full px-8 bg-emerald-600">
                    Back to Nutridex
                </Button>
            </div>
        );
