...
const RecipeCard = ({ recipe, mealLabel, unit = 'kJ', onRegenerate }: {
    ...
    return (
        <div className="group relative bg-card rounded-2xl border border-border overflow-hidden hover:shadow-lg transition-all animate-in fade-in zoom-in-95 duration-500 flex flex-col h-full">
            <Link href={`/dashboard/meals/${recipe.id}`} className="absolute inset-x-0 top-0 bottom-[140px] z-10" />
            ...
            <div className="p-5 flex flex-col flex-grow">
                ...
                <Link href={`/dashboard/meals/${recipe.id}`} className="mt-auto block w-full">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="relative">
                            <div className="flex bg-white dark:bg-slate-900/50 p-1.5 rounded-2xl border border-slate-200 dark:border-slate-800 gap-1 overflow-x-auto no-scrollbar items-center h-14 shadow-sm w-fit transition-all duration-500">
                                ...
                                <div className={cn("flex items-center gap-1 transition-all duration-500 ease-in-out overflow-hidden shrink-0", isFilterOpen ? "max-w-[1000px] opacity-100 px-1" : "max-w-0 opacity-0 px-0")}>
                                    {MEAL_TYPES.map(type => {
                                            ...
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    isActive
                                                        ...
                                                        : "hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-500 uppercase"
                                                )}
                                            >
                                                {type}
                                            </button>
                    ...
                    <div className="space-y-8 max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-4">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between px-2">
                                <button
                                    onClick={() => router.push('/dashboard/profile?from=/kitchen/mealplanner')}
                                                ...
                                                <div className={cn("p-6 pt-5 rounded-3xl border bg-gradient-to-br mb-6", t.bg)}>
                                                    ...
                                                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
                                                        {Object.entries(items).map(([label, keys]) => {
                                                            ...
                                                            return (
                                                                <div key={label} onClick={() => router.push(`/library/nutrients/${encodeURIComponent(label)}`)} className={cn("p-4 rounded-2xl border bg-white dark:bg-slate-950 cursor-pointer hover:shadow-md transition-all relative group", t.itemBorder, (pct !== null || title === 'Biological Ratios') ? `${styles.borderLight} ${styles.fade}` : "")}>
